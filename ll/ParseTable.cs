...
namespace LL
{
	...
	public class CfgLL1ParseTable : Dictionary<string,IDictionary<string,CfgLL1ParseTableEntry>>
	{
		...
		public int[][][] ToLL1Array(IList<string> symbolTable=null)
		{
			if(null==symbolTable)
			{
			...
			foreach(var r in this)
			{
				...
				{
					if (null != rr.Value.ConflictTable)
						throw new NotSupportedException("Conflict tables not supported in LL(1) parsers");
